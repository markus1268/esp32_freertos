...
void doTaskA(void *parameters)
{
    ...
    while (1)
    {
        xBytesSent = xStreamBufferSend(rxStream, (void *)ucArrayToSend, sizeof(ucArrayToSend), x100ms);
        ...
        xBytesSent = xStreamBufferSend(rxStream, (void *)pcStringToSend, strlen(pcStringToSend), 0);
...
void doTaskB(void *parameters)
{
    ...
    while (1)
    {
        xReceivedBytes = xStreamBufferReceive(rxStream, (void *)ucRxData, sizeof(ucRxData), portMAX_DELAY);
...
void setup()
{
    ...
    Serial.println();
    Serial.println("---FreeRTOS Stream Buffer Demo---");
